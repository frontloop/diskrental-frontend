<template>
    <p class="wrap">
        <div>
            <div class="headLabel">{{ rental.exemplar.item.title }}</div>
            <p class="details">
                <div class="createDate">{{ displayDate(rental.rentStartDate) }}</div>
                <div class="createDate">{{ displayDate(rental.plannedReturnDate) }}</div>
            </p>
